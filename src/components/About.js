    ...
    return (
        <div className="about-page">
            <div className="about-content">
                ...
                <p>ZECpages is a social networking site for zcash users. "Take it easy" is the ZECpages motto. A good reason to swing by is if you want to chat and make new friends.</p>
            </div>
            <div className="about-content">
