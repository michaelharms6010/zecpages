    ...
    return(
        <div className="z-board">
            <div className='zaddr-card board-info'>
                ...
                ZECpages currently recommends using <a target="_blank" rel="noopener noreferrer" style={{padding: '0', margin: '0'}}  href="https://zecwallet.co">ZecWallet</a> for best experience.
                </p>
            </div>
            {showViewKey && 
