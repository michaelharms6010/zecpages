...
ZECpages was a proof-of-concept "Blockchain MVC" app using Zcash shielded transaction memos as an api and data store for a simple social media board. The posts that appeared on ZECpages still exist on the Zcash blockchain.
